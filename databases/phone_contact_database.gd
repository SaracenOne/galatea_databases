...
class PhoneContactDatabase:
	...
	const DATABASE_NAME = "phone_contact_database"
	const DATABASE_NAME_JSON = "phone_contact_database.json"
	const DATABASE_NAME_BINARY = "phone_contact_database.gbd"
	const DATABASE_INLINED_FILENAME = "phone_contact_database_inlined.gd"
