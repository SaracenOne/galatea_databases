...
@export var texture_reference_control: NodePath  = NodePath()
...
@export var uses_alpha_control: NodePath  = NodePath()
@export var invert_alpha_control: NodePath  = NodePath()
