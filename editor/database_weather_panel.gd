...
const weather_record_const = preload("../databases/weather_record.gd")
...
@export var color_type_menu: NodePath  = NodePath()

@export var sunrise_color_picker_button: NodePath  = NodePath()
@export var day_color_picker_button: NodePath  = NodePath()
@export var sunset_color_picker_button: NodePath  = NodePath()
@export var night_color_picker_button: NodePath  = NodePath()

@export var layer_number_menu: NodePath  = NodePath()
@export var layer_texture_path: NodePath  = NodePath()
@export var layer_texture_preview: NodePath  = NodePath()
@export var layer_scroll_x: NodePath  = NodePath()
@export var layer_scroll_y: NodePath  = NodePath()
@export var layer_scroll_alpha: NodePath  = NodePath()

@export var precipitation_control: NodePath  = NodePath()

@export var wind_power: NodePath  = NodePath()
@export var wind_direction: NodePath  = NodePath()
@export var wind_variation: NodePath  = NodePath()
...
func _ready():
	_color_type_menu.get_popup().connect("item_pressed", Callable(self, "_color_type_selected"))
	_layer_number_menu.get_popup().connect("item_pressed", Callable(self, "_layer_number_selected"))
...
func set_color_selectors_to_record_colors(p_color_type):
	if(current_record):
		if(current_color_type == COLOR_TYPE_AMBIENT):
			_sunrise_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_SUNRISE].ambient_color)
			_day_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_DAY].ambient_color)
			_sunset_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_SUNSET].ambient_color)
			_night_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_NIGHT].ambient_color)
		elif(current_color_type == COLOR_TYPE_CLOUDS):
			_sunrise_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_SUNRISE].clouds_color)
			_day_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_DAY].clouds_color)
			_sunset_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_SUNSET].clouds_color)
			_night_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_NIGHT].clouds_color)
		elif(current_color_type == COLOR_TYPE_BEGIN_FOG):
			_sunrise_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_SUNRISE].begin_fog_color)
			_day_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_DAY].begin_fog_color)
			_sunset_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_SUNSET].begin_fog_color)
			_night_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_NIGHT].begin_fog_color)
		elif(current_color_type == COLOR_TYPE_END_FOG):
			_sunrise_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_SUNRISE].end_fog_color)
			_day_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_DAY].end_fog_color)
			_sunset_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_SUNSET].end_fog_color)
			_night_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_NIGHT].end_fog_color)
		elif(current_color_type == COLOR_TYPE_SKY_COLOR):
			_sunrise_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_SUNRISE].sky_color)
			_day_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_DAY].sky_color)
			_sunset_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_SUNSET].sky_color)
			_night_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_NIGHT].sky_color)
		elif(current_color_type == COLOR_TYPE_SUN_COLOR):
			_sunrise_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_SUNRISE].sun_color)
			_day_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_DAY].sun_color)
			_sunset_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_SUNSET].sun_color)
			_night_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_NIGHT].sun_color)
		elif(current_color_type == COLOR_TYPE_LIGHT_COLOR):
			_sunrise_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_SUNRISE].light_color)
			_day_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_DAY].light_color)
			_sunset_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_SUNSET].light_color)
			_night_color_picker_button.set_pick_color(current_record.color_sets[weather_record_const.TIME_NIGHT].light_color)

func set_layer_info_to_layer_number(p_layer_number):
	if(current_record):
		var cloud_path: String = current_record.cloud_layers[p_layer_number].cloud_path
...
func _on_TextureFilePathControl_file_selected(p_path: String):
	if(current_record):
